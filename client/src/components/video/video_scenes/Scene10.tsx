    ...
    >
      ...
      <div className="relative z-10 w-full text-center px-[5vw]">
        ...
        <motion.p
          ...
          style={{ fontSize: '1.6vw', marginTop: '1.5vw' }}
        ...
        <motion.div
          className="inline-flex items-center justify-center gap-[1.2vw] mt-[2.5vw] rounded-full border border-[#9B8659]/60 bg-[#9B8659]/15"
        ...
        {/* Footer chips */}
        <motion.div
          className="flex items-center justify-center gap-[2vw] mt-[1.8vw]"
