...
export const Scene5 = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute h-[0.15cqw] bg-[#9B8659]/70 origin-left"
        style={{
          width: '60cqw',
          top: '20%',
          left: '-10%',
      ...
      />
      <motion.div
        className="absolute h-[0.15cqw] bg-[#3B82F6]/70 origin-right"
        style={{
          width: '60cqw',
          bottom: '22%',
          right: '-10%',
      ...
      <div className="relative z-10 w-full text-center px-[4cqw]">
        ...
        >
          <img
            ...
            style={{ height: '2.5cqw', opacity: 0.85 }}
          />
        </motion.div>

        {/* Attention badge */}
        <motion.div
          className="inline-flex items-center justify-center gap-[1cqw] mb-[2cqw]"
        ...
        >
          <motion.div
            ...
            style={{ width: '0.8cqw', height: '0.8cqw' }}
